...
public class WordCounter {
    // Metodun adı testin inatla aradığı "calculatedWord" olarak güncellendi
    public static Map<String, Integer> calculatedWord() {
        ...
        // Özel karakterleri, noktalama işaretlerini sil ve küçük harfe çevir
        String cleanedText = text.replaceAll("[.,!?\"]", "").toLowerCase();
        
        // Boşluklardan parçala
